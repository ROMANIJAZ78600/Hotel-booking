      ...
      <form className='flex bg-white rounded-xl max-w-4xl max-md:mx-2'>
       ...
       {/* HOTEL NAME */}
            <div className='w-full mt-4'>
                ...
                <input type="text"  id="name" placeholder='Type here...' className='border 
            ...
            <div className='w-full mt-4'>
                ...
                <input type="text"  id="contact" placeholder='Type here...' className='border 
                border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light' required/>
            </div>
              {/* Address */}
            <div className='w-full mt-4'>
                <label htmlFor="address" className='font-medium text-gray-500'>Address</label>
                <input type="text"  id="address" placeholder='Type here...' className='border 
                border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light' required/>
            </div>
              {/* Drop Down */}
              <div className='w-full mt-4 max-w-60 mr-auto'>
                <label htmlFor="city" className='font-medium text-gray-500'>City</label>
                <select id="city" className='border border-gray-200 ounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light ' required>
