...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
      <Title title="My Bookings" subtitle="Easily manage your past, current and upcoming hotel reservaations in one place. Plan your trips seamlessly with just a few clicks." align='left'/>
